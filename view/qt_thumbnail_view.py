...
class QTThumbViewer(QMainWindow, AbstractThumbView):
    ...
    def add_preview(self, picture_fname:str, action=lambda: 0, popup_text='', label_top='',label_bottom=''):
        self.thumbs.add(picture_fname, action, popup_text, label_top,label_bottom)
