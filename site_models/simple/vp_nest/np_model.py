...
class NPSite(BaseSite):
    def start_button_name(self):
        return "NP"

    def startpage(self):
        return URL("http://www.novoporn.com/galleries")

    def can_accept_index_file(self, base_url=URL()):
        return base_url.contain('novoporn.com/')
    ...
    def parse_index_file(self, fname, base_url=URL()):
        ...
        picture_href_rule.set_attribute_filter_function('href', lambda x:x.find('/?category=')!=-1)
