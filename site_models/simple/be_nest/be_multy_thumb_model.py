...
class BEmultiThumbSite(BaseSite):
    ...
    def __init__(self, model=AbstractModelFromSiteInterface(), base_addr='e:/out/'):
        PJmenu=dict(Pics=URL('http://www.passionatejoy.com/'),Movies=URL('http://www.passionatejoy.com/adult-movies/'))
        FPEmenu=dict(Pics=URL('http://www.freepornerotica.com/'),Movies=URL('http://www.freepornerotica.com/porn-movies/'))
        PBmenu=dict(Pics=URL('http://www.pornobump.com/'),Movies=URL('http://www.pornobump.com/Porno-videos/'))
        FPSmenu=dict(Pics=URL('http://www.freepornosalute.com/'),Movies=URL('http://www.freepornosalute.com/Porno-videos/'))
        ...
        self.accepted_sites=[{'button':'PJ','start':'http://www.passionatejoy.com/','test':'passionatejoy.com/','menu':PJmenu},
                             {'button':'FPE','start':'http://www.freepornerotica.com/','test':'freepornerotica.com/','menu':FPEmenu},
                             {'button':'PB','start':'http://www.pornobump.com/','test':'pornobump.com/','menu':PBmenu},
                             {'button':'FPS','start':'http://www.freepornosalute.com/','test':'freepornosalute.com/','menu':FPSmenu},
